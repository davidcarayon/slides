---
title: "SK8 :skateboard: - Gestion et hébergement d'applications R Shiny sur des infrastructures INRAE"
date: "2023-05-26"
date-format: long
lang: fr  
author:
...
format: 
  inrae-revealjs:
    footer: "Café données EABX | 26/05/2023"
    theme: [custom.scss]
    transition: none
    code-overflow: wrap
revealjs-plugins:
...
::: columns
::: {.column width="50%"}
[![COVID19 Tracker](img/covid-tracker.png){width="80%" fig-align="center"}](https://vac-lshtm.shinyapps.io/ncov_tracker/#)
:::

::: {.column width="50%"}
[![Exemple EABX](img/covid-tracker.png){width="80%" fig-align="center"}](https://vac-lshtm.shinyapps.io/ncov_tracker/#)
:::
:::
=======
[![COVID19 Tracker](img/covid-tracker.png){width="80%" fig-align="center"}](https://vac-lshtm.shinyapps.io/ncov_tracker/#)
>>>>>>> 1fa5bc80349c0d29c39fbbcfb68c06494ba07879
...
-   Poster présenté aux rencontres R 2023 à Avignon
:::
...
{{< fa globe >}} <https://sk8.inrae.fr> (Rmarkdown, obsolète)

{{< fa globe >}} <https://sk8.pages.mia.inra.fr/projet_sk8/> (Quarto :building_construction:)
...
{{< fa brands slideshare >}} Slides consultables ici : <br> <https://david.carayon.pages.mia.inra.fr/slides/talks/2023-05-26_SK8_EABX/presentation_SK8_EABX>
