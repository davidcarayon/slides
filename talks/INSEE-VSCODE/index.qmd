...
::: {.incremental}
- IDEA Open-Source développé par Microsoft
- Disponible sous {{< fa brands apple >}} {{< fa brands windows >}} et {{< fa brands linux >}}
- Entièrement modulable (`config.json`) et formidable bibliothèque d'extensions
...
![](img/cap-color.png){fig-align="center" width="80%"}
...
- Outils développeur : linter…

## Interface Web

- Basé sur Electron
- git, ouvert dans github, gitlab ide web
