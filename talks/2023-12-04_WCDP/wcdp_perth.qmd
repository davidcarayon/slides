...
::: {.fragment .fade-up}
-   {{< fa warning >}} 20 to 30 deaths each year
:::
...
::: {.fragment .fade-up}
-   Emergency call database only covers [$\approx1.35\%$]{style="color:purple;font-size:1.4em;"}(:scream:) of all rescues
:::
...
Try our {{< fa registered >}} :package: [{DrowningAlert}](davidcarayon/drowningprediction) on {{< fa brands github >}} and get in touch with us !

![](assets/hex-DrowningAlert.png){width="10%" fig-align="center"}
...
{{< fa brands gitlab >}} Slides available [here]()
:::
